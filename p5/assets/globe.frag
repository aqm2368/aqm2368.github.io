...
vec3 palatte(float t) {
    vec3 a = vec3(0.408407346410207, 0.83840734641021, 0.5);
    vec3 b = vec3(0.848407346410207, 0.988407346410207, 0.988407346410207);
    vec3 c = vec3(0.498407346410207, -0.481592653589793, 0.898407346410207);
    vec3 d = vec3(-0.571592653589793, -0.571592653589793, 1.15840734641021);
